...
if (isset($_POST['btnsimpan'])) {
    ...
    if (move_uploaded_file($_FILES["foto_ktp"]["tmp_name"], $target_file_ktp) && move_uploaded_file($_FILES["foto_sim"]["tmp_name"], $target_file_sim)) {
        ...
        $total_harga = $durasi_sewa * 4350000;
        if ($supir == 1) {
            $total_harga += 200000;
        }

        // Query untuk menyimpan data ke dalam tabel pemesanan
        $query_sql = "INSERT INTO ducatidb (nama, alamat, email, nomor_hp, tanggal_peminjaman, foto_ktp, foto_sim, supir, durasi_sewa, total_harga)
...
<head>
  ...
  <title>Rental Motor Ducati</title>
...
<body>
  ...
  <div class="container clearfix">
    <div class="gambar-mobil">
        ...
        <img src="../../ICON GAMBAR/ducati.png" alt="Gambar Motor ducati" style="width: 100%;">
