...
if (isset($_POST['btnsimpan'])) {
    ...
    if (move_uploaded_file($_FILES["foto_ktp"]["tmp_name"], $target_file_ktp) && move_uploaded_file($_FILES["foto_sim"]["tmp_name"], $target_file_sim)) {
        ...
        $total_harga = $durasi_sewa * 70000;
        if ($supir == 1) {
            $total_harga += 200000;
        }

        // Query untuk menyimpan data ke dalam tabel pemesanan
        $query_sql = "INSERT INTO beatdb (nama, alamat, email, nomor_hp, tanggal_peminjaman, foto_ktp, foto_sim, supir, durasi_sewa, total_harga)
...
<body>
  ...
  <div class="container clearfix">
    <div class="gambar-mobil">
        <h1>Honda Beat 2024</h1>
        <img src="../../ICON GAMBAR/beat.png" alt="Gambar Mobil beat" style="width: 100%;">
        <p>2 KURSI / matic</p>
    </div>
