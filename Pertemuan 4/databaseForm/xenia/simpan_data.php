...
if (isset($_POST['btnsimpan'])) {
    ...
    if (move_uploaded_file($_FILES["foto_ktp"]["tmp_name"], $target_file_ktp) && move_uploaded_file($_FILES["foto_sim"]["tmp_name"], $target_file_sim)) {
        ...
        $query_sql = "INSERT INTO xeniadb (nama, alamat, email, nomor_hp, tanggal_peminjaman, foto_ktp, foto_sim, supir, durasi_sewa, total_harga)
...
<head>
  ...
  <title>Rental Mobil Xenia</title>
...
<body>
  ...
  <div class="container clearfix">
    <div class="gambar-mobil">
        <h1>NEW XENIA</h1>
        <img src="../../ICON GAMBAR/xenia.png" alt="Gambar Mobil Xenia" style="width: 100%;">
