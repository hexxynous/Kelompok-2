...
if (isset($_POST['btnsimpan'])) {
    ...
    if (move_uploaded_file($_FILES["foto_ktp"]["tmp_name"], $target_file_ktp) && move_uploaded_file($_FILES["foto_sim"]["tmp_name"], $target_file_sim)) {
        ...
        $total_harga = $durasi_sewa * 200000;
        if ($supir == 1) {
            $total_harga += 200000;
        }

        // Query untuk menyimpan data ke dalam tabel pemesanan
        $query_sql = "INSERT INTO kapaldb (nama, alamat, email, nomor_hp, tanggal_peminjaman, foto_ktp, foto_sim, supir, durasi_sewa, total_harga)
...
<body>
  ...
  <div class="container clearfix">
    <div class="gambar-mobil">
        <h1>NEW WOOD BOAT</h1>
        <img src="../../ICON GAMBAR/kapal.png" alt="Gambar kapal" style="width: 100%;">
        <p>3 KURSI / benar-benar MANUAL</p>
    </div>
